...
foreach (glob(dirname(__DIR__) . '/data/individual/account/113年總統、副總統選舉/賴清德_1.zip') as $zipFile) {
...
usort($incomes, "cmp");
$fh = fopen(dirname(__DIR__) . '/report/2024_incomes_lai.csv', 'w');
...
$fh = fopen(dirname(__DIR__) . '/report/2024_expenditures_lai.csv', 'w');
fputcsv($fh, array('money', 'name', 'id', 'owner', 'capital', 'status', 'date_of_establishment'));
