...
foreach(glob(dirname(__DIR__) . '/data/individual/account/111年*/*/*.zip') AS $zipFile) {
...
usort($incomes, "cmp");
$fh = fopen(dirname(__DIR__) . '/report/2022_incomes_sort.csv', 'w');
...
$fh = fopen(dirname(__DIR__) . '/report/2022_expenditures_sort.csv', 'w');
fputcsv($fh, array('money', 'name', 'id', 'owner', 'capital', 'status'));
